...
export function findComponentWithId(componentClass, id) {
  return getData(document.querySelector(`[data-component="${componentClass.componentName}"]#${id}`)).component;
};

/**
 * Mobile Check
 * 
 * https://stackoverflow.com/a/11381730/3542459
 */
 ...
 * BreakpointListener
 * 
 * Retrieve information when changing screen size according to provided breakpoints.
 * 
